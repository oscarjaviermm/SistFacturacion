...
{
    public class sistemafacturaJsonSerializationContractResolver : Newtonsoft.Json.Serialization.DefaultContractResolver
    {
...
{
    public static class sistemafacturaJsonMvcBuilderExtensions
    {
        public static IMvcBuilder AddsistemafacturaJsonOptions(this IMvcBuilder builder, Action<sistemafacturaJsonSerializationContractResolver> setupAction = null)
        {
            return builder.AddJsonOptions(opt =>
            {
                var resolver = new sistemafacturaJsonSerializationContractResolver();
